 ...
 * @author angel
 */
public class niveldeaguageneral extends javax.swing.JFrame {

    /**
     * Creates new form niveldeaguageneral
     */
    public niveldeaguageneral() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hora", "Fecha", "Almacenador", "Porcentaje de agua"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        bg.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 137, 470, 290));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(niveldeaguageneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new niveldeaguageneral().setVisible(true);
            }
        });
    }
