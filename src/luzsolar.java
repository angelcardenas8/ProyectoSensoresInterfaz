 ...
 * @author angel
 */
public class luzsolar extends javax.swing.JFrame {

    /**
     * Creates new form luzsolar
     */
    public luzsolar() {
        initComponents();
        String solicitud_url = "http://192.168.1.67/ProyectoSensores/public/api/luz";
        ...
        sol.setText("Tu porcentaje de entrada a las: "+fechayhora);
        sol2.setText("es de: \n "+porcentaje+"%");
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/icons8_solar_panel_40px_1.png"))); // NOI18N
        bg.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 260, 110, 70));

        jLabel11.setBackground(new java.awt.Color(153, 153, 153));
        jLabel11.setFont(new java.awt.Font("Franklin Gothic Medium Cond", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(102, 102, 102));
        jLabel11.setText("AQUI TIENES LA ENTRADA DE LUZ DE TU HOGAR.");
        bg.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 140, 320, -1));

        sol.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        bg.add(sol, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 180, 410, 50));

        sol2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        bg.add(sol2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 320, 90, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(luzsolar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
